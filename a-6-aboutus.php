                                      ...
                                      <table class="table table-hover table-condensed table-responsive">
                                          ...
                                          <tbody>
                                              <tr>
                                                  ...
                                                  <td>lorem ipsum</td>
                                                  <td>lorem ipsum</td>
                                                  <td><a data-toggle="modal" data-target="#editrestaurant"><i class="fa fa-edit"></i></a> &nbsp; <a data-toggle="modal" data-target="#deletemodal"><i class="fa fa-remove"></i></a></td>
                                              </tr>
                                          </tbody>
                                      </table>
                                  </div>
                                  ...
                                  <div class="row p20">
                                      <table class="table table-hover table-condensed table-responsive">
                                          ...
                                          <tbody>
                                              <tr>
                                                  <td>lorem ipsum</td>
                                                  <td><a data-toggle="modal" data-target="#editdepartment"><i class="fa fa-edit"></i></a> &nbsp; <a data-toggle="modal" data-target="#deletemodal"><i class="fa fa-remove"></i></a></td>
                                              </tr>
                                          </tbody>
                                      </table>
                                  </div>
                                  ...
                                  <div class="row p20">
                                      <table class="table table-hover table-condensed table-responsive">
                                          ...
                                          <tbody>
                                              <tr>
                                                  <td>lorem ipsum</td>
                                                  <td><a data-toggle="modal" data-target="#editjobtitle"><i class="fa fa-edit"></i></a> &nbsp; <a data-toggle="modal" data-target="#deletemodal"><i class="fa fa-remove"></i></a></td>
                                              </tr>
                                          </tbody>
                                      </table>
                                  </div>
